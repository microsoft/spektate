...
export const endTime = (deployment: IDeployment): Date => {
  ...
  //   deployment.hldToManifestBuild.lastUpdateTime
  // ) {
  //   const date = new Date(deployment.hldToManifestBuild.lastUpdateTime);
  //   if (!isNaN(date.getTime())) {
  //     return deployment.hldToManifestBuild.lastUpdateTime;
  //   }
  // } else if (
  //   deployment.dockerToHldRelease &&
  //   deployment.dockerToHldRelease.lastUpdateTime &&
  //   !isNaN(deployment.dockerToHldRelease.lastUpdateTime.getTime())
  // ) {
  //   return deployment.dockerToHldRelease.lastUpdateTime;
  // } else if (
  //   deployment.dockerToHldReleaseStage &&
  //   deployment.dockerToHldReleaseStage.lastUpdateTime &&
  //   !isNaN(deployment.dockerToHldReleaseStage.lastUpdateTime.getTime())
  // ) {
  //   return deployment.dockerToHldReleaseStage.lastUpdateTime;
  // } else if (
  //   deployment.srcToDockerBuild &&
  //   deployment.srcToDockerBuild.lastUpdateTime &&
  //   !isNaN(deployment.srcToDockerBuild.lastUpdateTime.getTime())
  // ) {
  //   return deployment.srcToDockerBuild.lastUpdateTime;
  // }
